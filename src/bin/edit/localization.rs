...
const S_LANG_LUT: [[&str; LangId::Count as usize]; LocId::Count as usize] = [
    ...
    [
        ...
        /* ja      */ "変更内容を保存しますか？",
        /* ko      */ "변경한 내용을 저장하시겠습니까?",
        /* pl      */ "Czy chcesz zapisać wprowadzone zmiany?",
    ...
    [
        ...
        /* pl      */ "Skopiowany tekst jest udostępniany do schowka terminala.",
    ...
    [
        ...
        /* pl      */ "Skopiowano {size}, udostępnienie może zająć dużo czasu.",
    ...
    [
        ...
        /* pl      */ "Skopiowany tekst jest zbyt duży, aby go udostępnić.",
    ...
    [
        ...
        /* pl      */ "Plik już istnieje. Czy chcesz go zastąpić?",
